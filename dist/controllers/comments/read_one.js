...
function ReadOneComment(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Get the comment's id
            const commentId = req.params._id;
            // Read comment
            const comment = yield comment_model_1.default
                .findOne({
            ...
            return (0, handler_1.SuccessResponse)(res, {
                message: constants_1.Messages.COMMENT_READ_SUCCESSFULLY,
                data: {
                    _id: comment._id,
...
exports.default = ReadOneComment;
