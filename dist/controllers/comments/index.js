...
router.post("/", (0, middleware_2.default)(schemas_1.AddComment), create_1.default);
router.get("/:_id", (0, middleware_2.default)(schemas_1.IdParameter, constants_1.RequestType.PARAMS), read_one_1.default);
router.get("/article/:_id", (0, middleware_2.default)(schemas_1.PaginationQuery, constants_1.RequestType.QUERY), (0, middleware_2.default)(schemas_1.IdParameter, constants_1.RequestType.PARAMS), read_all_1.default);
router.put("/:_id", (0, middleware_2.default)(schemas_1.IdParameter, constants_1.RequestType.PARAMS), (0, middleware_2.default)(schemas_1.UpdateCommentValidation), update_1.default);
